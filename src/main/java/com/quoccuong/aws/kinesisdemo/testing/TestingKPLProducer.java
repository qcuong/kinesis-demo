...
import com.quoccuong.aws.kinesisdemo.configuration.KinesisAPIProducer;
...
public class TestingKPLProducer {
    ...
    @Autowired
    private KinesisAPIProducer kinesisAPIProducer;
...
//            testingKPLProducer();
            testingKinesisAPIProducer();
        }, 10, 3, TimeUnit.SECONDS);
    }

    public void testingKPLProducer() {
    ...
    public void testingKinesisAPIProducer() {
        var phones = List.of("0945312485", "094356425");
        var userIds = List.of("customer_id_1", "customer_id_2");
        ...
        for (int i = 0; i < phones.size(); i++) {
            ...
            var userInfo = UserInfo.builder()
                    ...
                    .phoneNumber(phone)
                    .build();
            kinesisAPIProducer.putRecord(userInfo.getUserId(), userInfo);
        }
    }
